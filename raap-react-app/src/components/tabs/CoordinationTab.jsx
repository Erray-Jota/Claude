          ...
          <div style={{ padding: '0 8px' }}>
            ...
            <div style={{ background: '#FFFFFF', padding: '24px', borderRadius: '12px', border: '3px solid #065F46', marginBottom: '28px', boxShadow: '0 6px 18px rgba(0,0,0,0.1)' }}>
              <video
                ...
                muted
                loop
                style={{ width: '100%', borderRadius: '8px', border: '2px solid #16A34A' }}
              >
            ...
            {/* Key Benefits */}
            <div style={{ background: 'linear-gradient(135deg, #f0fdf4 0%, #ffffff 100%)', padding: '24px', borderRadius: '12px', border: '3px solid #16A34A', marginBottom: '28px', boxShadow: '0 6px 18px rgba(22, 163, 74, 0.15)' }}>
              <h3 style={{ fontSize: '24px', fontWeight: 900, color: COLORS.green.dark, marginBottom: '18px', textAlign: 'center', fontFamily: '-apple-system, BlinkMacSystemFont, "Segoe UI", sans-serif' }}>
                Modular Construction Advantages
              </h3>
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(250px, 1fr))', gap: '16px' }}>
                <div style={{ background: '#FFFFFF', padding: SPACING.lg, borderRadius: BORDERS.radius.md, border: '3px solid #16A34A', textAlign: 'center' }}>
                  <div style={{ fontSize: '32px', marginBottom: '8px' }}>⚡</div>
                  <div style={{ fontSize: FONTS.sizes.base, fontWeight: FONTS.weight.black, color: COLORS.green.dark }}>10 Months Faster</div>
                  <div style={{ fontSize: FONTS.sizes.sm, color: COLORS.gray.medium, marginTop: '4px' }}>Parallel design & fabrication</div>
                </div>
                <div style={{ background: '#FFFFFF', padding: SPACING.lg, borderRadius: BORDERS.radius.md, border: '3px solid #16A34A', textAlign: 'center' }}>
                  <div style={{ fontSize: '32px', marginBottom: '8px' }}>🎯</div>
                  <div style={{ fontSize: FONTS.sizes.base, fontWeight: FONTS.weight.black, color: COLORS.green.dark }}>Predictable Quality</div>
                  <div style={{ fontSize: FONTS.sizes.sm, color: COLORS.gray.medium, marginTop: '4px' }}>Factory-controlled environment</div>
                </div>
                <div style={{ background: '#FFFFFF', padding: SPACING.lg, borderRadius: BORDERS.radius.md, border: '3px solid #16A34A', textAlign: 'center' }}>
                  <div style={{ fontSize: '32px', marginBottom: '8px' }}>💰</div>
                  <div style={{ fontSize: FONTS.sizes.base, fontWeight: FONTS.weight.black, color: COLORS.green.dark }}>Cost Certainty</div>
                  <div style={{ fontSize: FONTS.sizes.sm, color: COLORS.gray.medium, marginTop: '4px' }}>Firm pricing, fewer surprises</div>
                </div>
                <div style={{ background: '#FFFFFF', padding: SPACING.lg, borderRadius: BORDERS.radius.md, border: '3px solid #16A34A', textAlign: 'center' }}>
                  <div style={{ fontSize: '32px', marginBottom: '8px' }}>🌱</div>
                  <div style={{ fontSize: FONTS.sizes.base, fontWeight: FONTS.weight.black, color: COLORS.green.dark }}>Sustainability</div>
                  <div style={{ fontSize: FONTS.sizes.sm, color: COLORS.gray.medium, marginTop: '4px' }}>Less waste, better efficiency</div>
                </div>
              </div>
            </div>
            ...
            <div style={{ background: '#FFFFFF', padding: '24px', borderRadius: '12px', border: '3px solid #065F46', marginBottom: '28px', boxShadow: '0 6px 18px rgba(0,0,0,0.1)' }}>
              <h3 style={{ fontSize: '24px', fontWeight: 900, color: COLORS.green.dark, marginBottom: '18px', textAlign: 'center', fontFamily: '-apple-system, BlinkMacSystemFont, "Segoe UI", sans-serif' }}>
                From Factory to Site: The Build Process
              </h3>

              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '20px' }}>
                {/* Transforming Prefab Video */}
                <div style={{ background: '#f9fafb', padding: SPACING.md, borderRadius: BORDERS.radius.md, border: '2px solid #16A34A' }}>
                  <h4 style={{ fontSize: FONTS.sizes.lg, fontWeight: FONTS.weight.bold, color: COLORS.green.dark, marginBottom: SPACING.sm, textAlign: 'center' }}>
                    Transforming Prefab
                  </h4>
                  <video
                    controls
                  ...
                  >
                    <source src="/images/Transforming Prefab.mp4" type="video/mp4" />
                    Your browser does not support the video tag.
                  </video>
                </div>
                ...
                <div style={{ background: '#f9fafb', padding: SPACING.md, borderRadius: BORDERS.radius.md, border: '2px solid #16A34A' }}>
                  ...
                  <video
                    ...
                    style={{ width: '100%', borderRadius: '6px' }}
                  >
                    <source src="/images/Walkthrough.mp4" type="video/mp4" />
                    Your browser does not support the video tag.
                  </video>
                </div>
              </div>
            ...
            {/* Multi-Story Assembly Examples */}
            <div style={{ background: '#FFFFFF', padding: '24px', borderRadius: '12px', border: '3px solid #065F46', marginBottom: '28px', boxShadow: '0 6px 18px rgba(0,0,0,0.1)' }}>
              <h3 style={{ fontSize: '24px', fontWeight: 900, color: COLORS.green.dark, marginBottom: '18px', textAlign: 'center', fontFamily: '-apple-system, BlinkMacSystemFont, "Segoe UI", sans-serif' }}>
                Multi-Story Modular Assembly
              </h3>

              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '20px' }}>
                {/* 3 Story */}
                <div style={{ background: '#f9fafb', padding: SPACING.md, borderRadius: BORDERS.radius.md, border: '2px solid #3B82F6' }}>
                  <h4 style={{ fontSize: FONTS.sizes.lg, fontWeight: FONTS.weight.bold, color: '#1E40AF', marginBottom: SPACING.sm, textAlign: 'center' }}>
                  ...
                  <video
                    ...
                    style={{ width: '100%', borderRadius: '6px' }}
                  >
                    <source src="/images/3 Story.mp4" type="video/mp4" />
                    Your browser does not support the video tag.
                  </video>
                </div>

                {/* 4 Story */}
                <div style={{ background: '#f9fafb', padding: SPACING.md, borderRadius: BORDERS.radius.md, border: '2px solid #8B5CF6' }}>
                  <h4 style={{ fontSize: FONTS.sizes.lg, fontWeight: FONTS.weight.bold, color: '#6D28D9', marginBottom: SPACING.sm, textAlign: 'center' }}>
                  ...
                  <video
                    ...
                    style={{ width: '100%', borderRadius: '6px' }}
                  >
                    <source src="/images/4 Story.mp4" type="video/mp4" />
                    Your browser does not support the video tag.
                  </video>
                </div>

                {/* 5 Story */}
                <div style={{ background: '#f9fafb', padding: SPACING.md, borderRadius: BORDERS.radius.md, border: '2px solid #DC2626' }}>
                  <h4 style={{ fontSize: FONTS.sizes.lg, fontWeight: FONTS.weight.bold, color: '#991B1B', marginBottom: SPACING.sm, textAlign: 'center' }}>
                  ...
                  <video
                    ...
                    style={{ width: '100%', borderRadius: '6px' }}
                  >
                    <source src="/images/5 Story.mp4" type="video/mp4" />
                    Your browser does not support the video tag.
                  </video>
                </div>
              </div>
            ...
            <div style={{ background: 'linear-gradient(135deg, #FFFBEB 0%, #FEF3C7 100%)', padding: '24px', borderRadius: '12px', border: '4px solid #D97706', marginBottom: '28px', boxShadow: '0 6px 18px rgba(217, 119, 6, 0.15)' }}>
              <h3 style={{ fontSize: '24px', fontWeight: 900, color: COLORS.gold.dark, marginBottom: '18px', textAlign: 'center', fontFamily: '-apple-system, BlinkMacSystemFont, "Segoe UI", sans-serif' }}>
                Typical Construction Timeline
              </h3>
              <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
                <div style={{ background: '#FFFFFF', padding: SPACING.lg, borderRadius: BORDERS.radius.md, border: '2px solid #D97706', display: 'flex', alignItems: 'center', gap: SPACING.md }}>
                  <div style={{ fontSize: '24px', minWidth: '40px', textAlign: 'center' }}>1️⃣</div>
                  <div>
                    <div style={{ fontSize: FONTS.sizes.base, fontWeight: FONTS.weight.black, color: COLORS.gold.dark }}>Site Preparation (Weeks 1-2)</div>
                    <div style={{ fontSize: FONTS.sizes.sm, color: COLORS.gray.medium }}>Foundation, utilities, staging area setup</div>
                  </div>
                </div>
                <div style={{ background: '#FFFFFF', padding: SPACING.lg, borderRadius: BORDERS.radius.md, border: '2px solid #D97706', display: 'flex', alignItems: 'center', gap: SPACING.md }}>
                  <div style={{ fontSize: '24px', minWidth: '40px', textAlign: 'center' }}>2️⃣</div>
                  <div>
                    <div style={{ fontSize: FONTS.sizes.base, fontWeight: FONTS.weight.black, color: COLORS.gold.dark }}>Module Delivery (Weeks 3-4)</div>
                    <div style={{ fontSize: FONTS.sizes.sm, color: COLORS.gray.medium }}>Coordinated transport from factory to site</div>
                  </div>
                </div>
                <div style={{ background: '#FFFFFF', padding: SPACING.lg, borderRadius: BORDERS.radius.md, border: '2px solid #D97706', display: 'flex', alignItems: 'center', gap: SPACING.md }}>
                  <div style={{ fontSize: '24px', minWidth: '40px', textAlign: 'center' }}>3️⃣</div>
                  <div>
                    <div style={{ fontSize: FONTS.sizes.base, fontWeight: FONTS.weight.black, color: COLORS.gold.dark }}>Module Setting (Weeks 4-6)</div>
                    <div style={{ fontSize: FONTS.sizes.sm, color: COLORS.gray.medium }}>Crane operations, module placement & connection</div>
                  </div>
                </div>
                <div style={{ background: '#FFFFFF', padding: SPACING.lg, borderRadius: BORDERS.radius.md, border: '2px solid #D97706', display: 'flex', alignItems: 'center', gap: SPACING.md }}>
                  <div style={{ fontSize: '24px', minWidth: '40px', textAlign: 'center' }}>4️⃣</div>
                  <div>
                    <div style={{ fontSize: FONTS.sizes.base, fontWeight: FONTS.weight.black, color: COLORS.gold.dark }}>Site Finish Work (Weeks 7-10)</div>
                    <div style={{ fontSize: FONTS.sizes.sm, color: COLORS.gray.medium }}>MEP connections, exterior finishes, final inspections</div>
                  </div>
                </div>
              </div>
            </div>
            ...
            {/* Call to Action */}
            <div style={{ background: 'linear-gradient(135deg, #065F46 0%, #047857 100%)', padding: '28px', borderRadius: '12px', border: '4px solid #16A34A', boxShadow: '0 8px 24px rgba(6, 95, 70, 0.3)', textAlign: 'center' }}>
              <h3 style={{ fontSize: '28px', fontWeight: 900, color: '#FFFFFF', marginBottom: '12px', fontFamily: '-apple-system, BlinkMacSystemFont, "Segoe UI", sans-serif' }}>
                Ready to Transform Your Construction Process?
              </h3>
              <p style={{ fontSize: FONTS.sizes.lg, color: '#D1FAE5', marginBottom: '0px', lineHeight: '1.6', fontFamily: '-apple-system, BlinkMacSystemFont, "Segoe UI", sans-serif' }}>
                Let RaaP guide you through every phase—from feasibility to fabrication—with proven processes that deliver faster timelines, predictable costs, and superior quality.
              </p>
            </div>
          </div>
        )}
